...
/// 使用 CVPixelBuffer 实现零拷贝渲染。
public class IOSRendererProvider: NSObject {
    ...
    ///
    /// - Parameter registry: Flutter TextureRegistry
    /// - Returns: Texture ID
    ...
    /// 更新 PixelBuffer
    ///
    /// 从 ijkplayer 获取的 CVPixelBuffer 通过此方法传递给 Flutter。
    /// 这是零拷贝渲染的核心 - CVPixelBuffer 直接被 Flutter 使用。
...
extension IOSRendererProvider: FlutterTexture {
